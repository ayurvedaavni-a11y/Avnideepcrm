    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 flex items-center gap-3">
        <div className="relative flex-1">
          ...
          <input id="payment-search" name="payment-search" aria-label="Search payments" type="text" autoComplete="search" placeholder="Search by invoice, customer, or mobile…" value={search} onChange={(e) => setSearch(e.target.value)} className="pl-10 pr-4 py-2 border border-slate-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
      </div>
