...
1. Supabase **Authentication → Users → Add user** kholen:
   ...
   - Password: 6-digit PIN, e.g. `123456`

> **Zaroori:** Login PIN **6 digits** ka rakhein. Supabase ki default **minimum password length (6)** yahi rakhein — 6 se kam PIN par "Password should be at least 6 characters" error aayega.
